...
public class StudentLoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        email = view.findViewById(R.id.et_email_student);
        password = view.findViewById(R.id.et_password_student);
        forgotPassword = view.findViewById(R.id.tv_forgot_password_student);
        login = view.findViewById(R.id.btn_login_student);
        register = view.findViewById(R.id.btn_register_student);
        loginError = view.findViewById(R.id.tv_login_error);
                        ...
                        ValueEventListener valueEventListener = new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    mAuth.signOut();
                                    loginError.setVisibility(View.VISIBLE);
                                    loginError.setText("You are not student please login in different account");
                                    mDialog.dismiss();
                                    login.setVisibility(View.VISIBLE);
                                }
                            }
